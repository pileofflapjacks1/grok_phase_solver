...
**Working draft · software package v0.13.4 (MIT)**  
...
`gps-solve` / `gps-gui`: SHELX HKL/INS, CIF HKL, MTZ → phases, density, peaks, `report.md` (seed-quality Class 0/1 section), **`trial.res`** for Olex2/SHELXL. Package on PyPI as `grok-phase-solver` ≥ **0.13.4** (https://pypi.org/project/grok-phase-solver/0.13.4/).
...
```bash
# Library
python -m pip install "grok-phase-solver>=0.13.4"
# or from source
...
- Source: MIT, GitHub `pileofflapjacks1/grok_phase_solver`, tag **`v0.13.4`**  
- PyPI: [`grok-phase-solver` 0.13.4](https://pypi.org/project/grok-phase-solver/0.13.4/)  
...
14. Grok (xAI) and Joe (2026) — *grok_phase_solver* **v0.13.4** (this work).  
