...
| Release | software **0.13.4** · tag `v0.13.4` · [PyPI](https://pypi.org/project/grok-phase-solver/0.13.4/) |
...
- [x] Version aligned to package **0.13.4** (science claim freeze still 0.13.1 scoreboards)  
