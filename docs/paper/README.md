...
| Release | software **0.13.3** · tag `v0.13.3` · [PyPI](https://pypi.org/project/grok-phase-solver/0.13.3/) |
...
- [x] Version aligned to package **0.13.3** (science claim freeze still 0.13.1 scoreboards)  
