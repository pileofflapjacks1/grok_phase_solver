...
Version **0.13.2** · Python ≥ 3.10 · MIT
...
Release notes: [`docs/RELEASE.md`](docs/RELEASE.md) · [v0.13.2 notes](docs/RELEASE_NOTES_v0.13.2.md) · [Paper PDF](docs/paper/arxiv_draft.pdf)
...
| Graph prior strong-seed quality ~**21–24%** ≤20° (below 30% bar) through **v11** pilots | [`strong_prior_v11.md`](data/processed/strong_prior_v11.md) |
