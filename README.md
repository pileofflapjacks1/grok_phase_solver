...
| **SHELXS (external)** | `solvers/shelxs_runner.py` | Academic SHELXS binary → peak list → phases (H2H) |
...
| Strong GraphPhaseNet prior | `python scripts/train_strong_prior.py --scale --wilson-match` | [`strong_prior.md`](data/processed/strong_prior.md) |
...
| SHELXS head-to-head | `python scripts/run_shelxs_h2h.py` | [`shelxs_h2h.md`](data/processed/shelxs_h2h.md), [`docs/math/shelxs_h2h.md`](docs/math/shelxs_h2h.md) |
