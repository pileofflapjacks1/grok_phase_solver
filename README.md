...
Version **0.13.1** · Python ≥ 3.10 · MIT
...
Release notes: [`docs/RELEASE.md`](docs/RELEASE.md) · [v0.13.1 notes](docs/RELEASE_NOTES_v0.13.1.md) · [Paper PDF](docs/paper/arxiv_draft.pdf)
