...
def _render_report(result: "SolveResult") -> str:
    ...
    lines.extend(
        [
            ...
            "3. **Open** `trial.res` in Olex2 — hand-build from Q peaks (assign elements; not a refinable start).",
            "4. After hand-build / element assignment, refine with **SHELXL** if ready:",
            "   ```bash",
